...
(function () {
    const translations = {
        en: {
            ...
            'header.useLocation': 'Use My Location',
            'header.useLocationTitle': 'Detect my location automatically',
            'header.locating': 'Finding your location...',
            'header.locatedAt': 'Location set to {loc}',
            'header.locateFailed': "Couldn't get your location. Check location permission, or type a ZIP.",
            'header.locateUnsupported': 'This device cannot share its location. Please type a ZIP code.',
            ...
            'retailer.inStock': 'Listed in stock by TX Lottery',
        ...
        es: {
            ...
            'header.useLocation': 'Usar mi ubicación',
            'header.useLocationTitle': 'Detectar mi ubicación automáticamente',
            'header.locating': 'Buscando tu ubicación...',
            'header.locatedAt': 'Ubicación establecida en {loc}',
            'header.locateFailed': 'No se pudo obtener tu ubicación. Revisa los permisos o escribe un código postal.',
            'header.locateUnsupported': 'Este dispositivo no puede compartir su ubicación. Escribe un código postal.',
            ...
            'retailer.inStock': 'La Lotería lo indica en existencia',
